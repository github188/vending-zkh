...
public class VendingChnData extends BaseParseData implements Serializable {
	...
	private String vc1Cn1Id;

	/**
	 * @author junjie.you
	 * @return the vc1Cn1Id
	 */
	public String getVc1Cn1Id() {
		return vc1Cn1Id;
	}
	 ...
	 *            the vc1Cn1Id to set
	 */
	public void setVc1Cn1Id(String vc1Cn1Id) {
		this.vc1Cn1Id = vc1Cn1Id;
	}
	...
	public String toString() {
		return "VendingChnData [vc1Id=" + vc1Id + ", vc1M02Id=" + vc1M02Id + ", vc1Vd1Id=" + vc1Vd1Id + ", vc1Code="
				...
				+ ", vc1ColumnNum=" + vc1ColumnNum + ", vc1Height=" + vc1Height + ", vc1CreateUser=" + vc1CreateUser
				+ ", vc1CreateTime=" + vc1CreateTime + ", vc1ModifyUser=" + vc1ModifyUser + ", vc1ModifyTime="
				+ vc1ModifyTime + ", vc1RowVersion=" + vc1RowVersion + ",vc1Cn1Id=" + vc1Cn1Id + "]";
	}
