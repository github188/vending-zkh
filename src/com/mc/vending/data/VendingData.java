...
public class VendingData extends BaseParseData implements Serializable {
    ...
    public String toString() {
        return "VendingData [vd1Id=" + vd1Id + ", vd1M02Id=" + vd1M02Id + ", vd1Code=" + vd1Code
                + ", vd1Manufacturer=" + vd1Manufacturer + ", vd1Vm1Id=" + vd1Vm1Id + ", vd1LastVersion="
                + vd1LastVersion + ", vd1LwhSize=" + vd1LwhSize + ", vd1Color=" + vd1Color
                + ", vd1InstallAddress=" + vd1InstallAddress + ", vd1Coordinate=" + vd1Coordinate
                + ", vd1St1Id=" + vd1St1Id + ", vd1EmergencyRel=" + vd1EmergencyRel
                + ", vd1EmergencyRelPhone=" + vd1EmergencyRelPhone + ", vd1OnlineStatus=" + vd1OnlineStatus
                + ", vd1Status=" + vd1Status + ", vd1CreateUser=" + vd1CreateUser + ", vd1CreateTime="
                + vd1CreateTime + ", vd1ModifyUser=" + vd1ModifyUser + ", vd1ModifyTime=" + vd1ModifyTime
                + ", vd1RowVersion=" + vd1RowVersion + ", vd1CardType=" + vd1CardType + "]";
    }
