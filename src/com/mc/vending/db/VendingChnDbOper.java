...
public class VendingChnDbOper {
    ...
    public List<VendingChnData> findAll() {
        ...
        while (c.moveToNext()) {
            ...
            vendingChn.setVc1Cn1Id(c.getString(c.getColumnIndex("VC1_CN1_ID")));
    ...
    public VendingChnData getVendingChnByCode(String vendingChnCode, String vcId) {
        ...
        Cursor c = db.rawQuery(
            "SELECT * FROM VendingChn WHERE VC1_CODE=? and VC1_VD1_ID=? limit 1", new String[] {
                    vendingChnCode, vcId });
        while (c.moveToNext()) {
            vendingChn = new VendingChnData();
            vendingChn.setVc1Id(c.getString(c.getColumnIndex("VC1_ID")));
     ...
     * @param skuId  多个SKUID连接组成的SKUID串
     * @return
     */
    public List<VendingChnData> findVendingChnBySkuIds(String skuIds) {
        ...
        SQLiteDatabase db = AssetsDatabaseManager.getManager().getDatabase();
        Cursor c = db.rawQuery(
            "SELECT * FROM VendingChn WHERE VC1_Status=1 and VC1_Type=1 and VC1_PD1_ID IN("
                    + skuIds + ") ORDER by VC1_CODE", null);
        while (c.moveToNext()) {
            VendingChnData vendingChn = new VendingChnData();
            vendingChn.setVc1Id(c.getString(c.getColumnIndex("VC1_ID")));
            vendingChn.setVc1M02Id(c.getString(c.getColumnIndex("VC1_M02_ID")));
     ...
     * @param skuId  SKUID
     * @param chnStatus 售货机货道状态
     * @param chnType 货道类型
     * @return
     */
    public List<ChnStockWrapperData> findVendingChnBySkuId(String skuId, String chnStatus,
                                                           String chnType) {
    ...
    public boolean addVendingChn(VendingChnData vendingChn) {
        ...
        stat.bindString(21, vendingChn.getVc1Cn1Id());
