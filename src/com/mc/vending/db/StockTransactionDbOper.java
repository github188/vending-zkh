...
public class StockTransactionDbOper {
	...
	public void clearStockTransaction(String startDate) {
		String updateSql = "delete StockTransaction where TS1_UploadStatus='" + StockTransactionData.UPLOAD_LOAD
				+ "' and substr(TS1_createtime,0,11) <= ?";
		SQLiteDatabase db = AssetsDatabaseManager.getManager().getDatabase();
	...
	public int getTransQtyCount(String billType, String vendingId, String skuId, String vendingChnCode,
		...
		Cursor c = db.rawQuery(
				"SELECT TS1_TransQty FROM StockTransaction WHERE TS1_BillType=? and TS1_VD1_ID=? "
						+ "and TS1_PD1_ID=? and TS1_CreateTime>=? and TS1_CD1_ID =?",
...
//			transQtyCount = transQtyCount * ConvertHelper.toInt(conversionData.getCn1Proportion(), 1);
//			// 最终结果要进行单位换算
//			// modified
//			// by
//			// junjie.you
