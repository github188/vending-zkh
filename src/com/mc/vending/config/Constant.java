...
public class Constant {
	...
	public final static String HEADER_VALUE_CLIENTVER = "0.3.14"; // client_ver
	...
	public final static Map<String, String> WSIDNAMEMAP = new HashMap<String, String>() {
		...
		{
			put("2f744c20-e5d9-4392-9ac2-1f4a6c7bdd00", "超级密码接口");
			put("71526d0a-7a6e-434d-b226-0a04feffe4ec", "检查是否可以初始化");
			put("6e2164cc-45a9-46a4-85a4-b6e3377ebc33", "数据同步时请求接口");
			put("e0a9f1eb-180b-4d3a-956b-e6df0b394a0f", "3.4版本信息接口");
			put("d5dd9d99-5fd3-4973-a4ad-ee6d516ca537", "3.4认证准入接口");
			put("5da83d05-e941-4059-ad49-85ebf2d32de3", "3.5接口配置接口");
			put("0f1e740c-c41a-484f-afe3-8e7f2eff99ee", "3.6售货机接口");
			put("c6c1dc3d-95f4-4e2f-80e8-6e3505d03895", "3.7待机界面图片接口");
			put("7698adeb-d59b-4eb5-ba20-d635f988fa7c", "3.8售货机货道接口");
			put("7395899e-a13b-4de9-8d6b-d48d09a39915", "3.9售货机产品接口");
			put("c81e6175-a15c-47b8-a3e2-a6c2fbf9d98b", "3.10产品接口");
			put("0cec0063-a032-4a37-aa45-889d554023d8", "3.11产品图片接口");
			put("66b91d60-808b-4109-9dc2-2b9f08349bee", "3.12货主接口");
			put("72be83fe-24ca-4bf5-9851-248c3391d67a", "3.13站点接口");
			put("c2da7bde-f824-4066-bf93-fcdf94690ac0", "3.14售货机卡/密码权限");
			put("f821ae2c-1f02-4e6c-a7c4-e11661b4da60", "3.15产品领料权限接口");
			put("4f4e0f23-9b81-4b82-885d-6b9e07ebec18", "3.16卡/密码接口");
			put("be98e646-5160-49ac-a986-05cd073393f7", "3.17客户员工卡/密码权限接口");
			put("f42b379f-b3c9-4b09-96e1-4bd21c05ae7f", "3.18客户员工接口");
			put("5090a50f-fa68-4691-a0bb-af1b38676500", "3.19客户接口");
			put("de22c9b4-1be2-4301-a3cc-36c66a7aa9da", "3.20产品组合接口");
			put("e8030392-15d7-467f-97ef-897a59dc039a", "3.21产品组合权限接口");
			put("7f342da0-05be-4f3a-96c3-28072ec31e7a", "3.22补货单接口");
			put("badc8989-320d-4122-8b40-1e5b4ec2541c", "3.23售货机在线状态更新接口");
			put("7f342da0-05be-4f3a-96c3-28072ec31e7a", "3.24补货单状态更新接口");
			put("7f342da0-05be-4f3a-96c3-28072ec31e7a", "3.25补货单接口");
			put("7774bf40-e172-4daf-88cb-e7cecfdc86bd", "3.26盘点记录接口");
			put("f5051735-42a1-4003-afbf-b18b3d87c8f0", "3.27库存交易记录");
			put("b7e4d092-5c3c-4f73-b793-caf197826340", "3.38同步库存");
			put("c7aff256-e10b-4ee1-bd2e-f3670208aed1", "3.39APP接口调用返回");
			put(METHOD_WSID_RETURNS_FORWARD, "3.40退货单接口");
			put(METHOD_WSID_USEDRECORD, "卡产品领用接口");
			put(METHOD_WSID_PRODUCTCARDPOWER, "卡产品权限接口");
			put(METHOD_WSID_CONVERSION, "单位换算关系接口");
		}
	};
