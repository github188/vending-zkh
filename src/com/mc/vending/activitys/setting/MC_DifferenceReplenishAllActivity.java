...
public class MC_DifferenceReplenishAllActivity extends BaseActivity {
    ...
    public void backClicked(View view) {
        Intent intent = new Intent(MC_DifferenceReplenishAllActivity.this,
        ...
        Thread downLoadData = new Thread(new Runnable() {
            public void run() {
                ...
                ServiceResult<Boolean> result = ReplenishmentService.getInstance()
                    .updateReplenishmentDetail(headData, dataList, wrapperData,StockTransactionData.BILL_TYPE_DIFFAll);
                if (!result.isSuccess()) {
                ...
                Message msg = handler.obtainMessage();
                msg.obj = "差异补满完成";
                msg.what = MC_SettingActivity.SET_DifferenceReplenishAll;
                                ...
                                public void handleMessage(Message msg) {
                                    switch (msg.what) {
                                        case MC_SettingActivity.SET_ERROR:
                                            ...
                                            break;
                                        case MC_SettingActivity.SET_DifferenceReplenishAll:
                                            resetAlertMsg((String) msg.obj);
                                            goBack();
                                            break;

                                        case MC_SettingActivity.SET_SUCCESS:
                                            adapter = new MC_DifferenceReplenishAllAdapter(
                                                MC_DifferenceReplenishAllActivity.this, dataList,
                                                listView);
