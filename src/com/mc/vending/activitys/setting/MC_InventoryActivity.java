...
public class MC_InventoryActivity extends BaseActivity implements MC_SerialToolsListener {
    ...
    private void initObject() {
        orderNumber = "I" + DateHelper.format(new Date(), "yyyy");
        tv_public_title.setText(getResources().getString(R.string.set_inventory));
        tv_number_title.setText(getResources().getString(R.string.inventory_order_id) + " "
                                + orderNumber);
        set_difference_replenishment.setText(getResources().getString(R.string.inventory_number));
    ...
    private void requestLst() {
        ...
        Thread downLoadData = new Thread(new Runnable() {
            public void run() {
                dataList = InventoryService.getInstance().findChnCodeProductName();
    ...
    public void saveClicked(View view) {
        ...
        Thread downLoadData = new Thread(new Runnable() {
            public void run() {
                ...
                ServiceResult<Boolean> result = InventoryService.getInstance()
                ...
                Message msg = handler.obtainMessage();
                msg.obj = "盘点完成";
                msg.what = MC_SettingActivity.SET_Inventory;
                handler.sendMessage(msg);
                                ...
                                public void handleMessage(Message msg) {
                                    switch (msg.what) {
                                        case MC_SettingActivity.SET_ERROR:
                                            ...
                                            break;
                                        case MC_SettingActivity.SET_Inventory:
                                            stopLoading();
                                            resetAlertMsg((String) msg.obj);
                                            finish();
                                            break;
                                        case MC_SettingActivity.SET_SUCCESS:
                                            adapter = new MC_UrgentReplenishmentAdapter(
                                                MC_InventoryActivity.this, dataList, listView);
