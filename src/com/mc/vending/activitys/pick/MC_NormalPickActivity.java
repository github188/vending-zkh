    ...
    private void channelValidate() {
        ...
        if (StringHelper.isEmpty(et_channle_number.getText().toString(), true)) {
            ...
            if (et_channle_number.getText().toString().equals(Constant.SERVICE_TEL)) {
                ...
                ServiceResult<VendingChnData> vendingResult = GeneralMaterialService.getInstance()
                ...
                // 查询商品图片
                ProductPictureData picData = GeneralMaterialService.getInstance().getPictureBySkuId(
                ...
                stockCount = GeneralMaterialService.getInstance().getVendingChnStock(
                        vendingChn.getVc1Vd1Id(), vendingChn.getVc1Code());
                if (stockCount <= 0) {
        ...
        if (StringHelper.isEmpty(et_card_password.getText().toString(), true)) {
            ...
            ServiceResult<Boolean> materialResult = GeneralMaterialService.getInstance()
                    .checkProductMaterialPower(vendingChn.getVc1Vd1Id(), vendingChn.getVc1Pd1Id(),
                            ...
                            ConvertHelper.toInt(et_pick_number.getText().toString(), 0),
                            vendingChn.getVc1Code(), wrapperData.getCardPuductPowerType(),
