...
public class MC_ImagePlayerActivity extends BaseActivity implements MC_SerialToolsListener {
	...
	final public Handler mHander = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case SerialTools.MESSAGE_LOG_mKeyBoard:
				...
				if (SerialTools.FUNCTION_KEY_COMBINATION.equals(value) || SerialTools.FUNCTION_KEY_BORROW.equals(value)
						|| SerialTools.FUNCTION_KEY_BACK.equals(value) || SerialTools.FUNCTION_KEY_SET.equals(value)
						|| SerialTools.FUNCTION_KEY_CANCEL.equals(value)
						|| SerialTools.FUNCTION_KEY_CONFIRM.equals(value)
						|| "0".equals(SerialTools.getInstance().getKeyValue(value))
						|| "1".equals(SerialTools.getInstance().getKeyValue(value))
						|| "2".equals(SerialTools.getInstance().getKeyValue(value))
						|| "3".equals(SerialTools.getInstance().getKeyValue(value))
						|| "4".equals(SerialTools.getInstance().getKeyValue(value))
						|| "5".equals(SerialTools.getInstance().getKeyValue(value))
						|| "6".equals(SerialTools.getInstance().getKeyValue(value))
						|| "7".equals(SerialTools.getInstance().getKeyValue(value))
						|| "8".equals(SerialTools.getInstance().getKeyValue(value))
						|| "9".equals(SerialTools.getInstance().getKeyValue(value))) {
					isStop = true;
					finish();
				}
			default:
	...
	public void imagePlayerClicked(View view) {
		...
		intent.setClass(MC_ImagePlayerActivity.this, MC_IntelligencePickActivity.class);
