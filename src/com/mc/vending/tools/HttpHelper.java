...
public class HttpHelper {
	...
	public static BaseData requestToParse(Class className, String method, JSONObject param, BaseData baseData)
		...
		json.put(Constant.BODY_KEY_UDID, Tools.getMacAddress());
		...
		httpPost.setHeader(Constant.HEADER_KEY_CLIENTVER, HttpHelper.getHeaderMap().get(Constant.HEADER_KEY_CLIENTVER));
