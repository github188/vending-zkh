...
public class DataServices extends Service implements DataParseRequestListener, Serializable {
	...
	// Conversion(CN1_ID,CN1_Upid,CN1_Cpid,CN1_Proportion,CN1_Operation,CN1_CreateTime)
	// VALUES('1','1b8ff138-f61b-4077-881e-db6e109b9025','b83ebde2-fa9f-451b-8757-3cd8a9d6f692','12','打','20151019');";

	// private String sql202 = "CREATE TABLE if not exists ReturnForward ( id
	// varchar(100) NOT NULL, RT1_M02_ID varchar(100), RT1_RTCode varchar(100),
	// RT1_Type varchar(10), RT1_CU1_ID varchar(100), RT1_VD1_ID varchar(100),
	...
	public void resetVending(String vcCode) {
		...
		parse.requestVendingData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_VENDING, vendingCode,
				initFlag);
	}
	...
	private void startDownloadTimer() {
		...
		vendingTask = new TimerTask() {
			...
			public void run() {
				...
				InterfaceData vendingConfig = configMap
						.get(Constant.METHOD_WSID_VENDING + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
	...
	private void resetTimerLength() {
		...
		// InterfaceData configConfig =
		// configMap.get(Constant.METHOD_WSID_CONFIG + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		// configTimerLength = configConfig != null ?
		// configConfig.getM03ExeInterval() * standardInterval
		// : configTimerLength;

		InterfaceData vendingPictureConfig = configMap
				.get(Constant.METHOD_WSID_VENDINGPICTURE + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		vendingPictureTimerLength = vendingPictureConfig != null
				? vendingPictureConfig.getM03ExeInterval() * standardInterval : vendingPictureTimerLength;

		InterfaceData vendingChnConfig = configMap
				.get(Constant.METHOD_WSID_VENDINGCHN + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		vendingChnTimerLength = vendingChnConfig != null ? vendingChnConfig.getM03ExeInterval() * standardInterval
				: vendingChnTimerLength;

		InterfaceData vendingProLinkConfig = configMap
				.get(Constant.METHOD_WSID_VENDINGPROLINK + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		vendingProLinkTimerLength = vendingProLinkConfig != null
				? vendingProLinkConfig.getM03ExeInterval() * standardInterval : vendingProLinkTimerLength;

		InterfaceData vendingCardPowerConfig = configMap
				.get(Constant.METHOD_WSID_VENDINGCARDPOWER + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		vendingCardPowerTimerLength = vendingCardPowerConfig != null
				? vendingCardPowerConfig.getM03ExeInterval() * standardInterval : vendingCardPowerTimerLength;

		InterfaceData productMaterialPowerConfig = configMap
				.get(Constant.METHOD_WSID_PRODUCTMATERIAKPOWER + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		productMaterialPowerTimerLength = productMaterialPowerConfig != null
				? productMaterialPowerConfig.getM03ExeInterval() * standardInterval : productMaterialPowerTimerLength;

		InterfaceData cardConfig = configMap.get(Constant.METHOD_WSID_CARD + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		cardTimerLength = cardConfig != null ? cardConfig.getM03ExeInterval() * standardInterval : cardTimerLength;

		InterfaceData cusEmpCardPowerConfig = configMap
				.get(Constant.METHOD_WSID_CUSEMPCARDPOWER + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		cusEmpCardPowerTimerLength = cusEmpCardPowerConfig != null
				? cusEmpCardPowerConfig.getM03ExeInterval() * standardInterval : cusEmpCardPowerTimerLength;

		InterfaceData customerEmpLinkConfig = configMap
				.get(Constant.METHOD_WSID_CUSTOMEREMPLINK + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		customerEmpLinkTimerLength = customerEmpLinkConfig != null
				? customerEmpLinkConfig.getM03ExeInterval() * standardInterval : customerEmpLinkTimerLength;

		InterfaceData customerConfig = configMap
				.get(Constant.METHOD_WSID_CUSTOMER + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		customerTimerLength = customerConfig != null ? customerConfig.getM03ExeInterval() * standardInterval
				: customerTimerLength;

		InterfaceData productGroupConfig = configMap
				.get(Constant.METHOD_WSID_PRODUCTGROUP + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		InterfaceData productGroupPowerConfig = configMap
				.get(Constant.METHOD_WSID_PRODUCTGROUPPOWER + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		productGroupPowerTimerLength = productGroupPowerConfig != null
				? productGroupPowerConfig.getM03ExeInterval() * standardInterval : productGroupPowerTimerLength;
		...
		productPictureTimerLength = productPictureConfig != null
				? productPictureConfig.getM03ExeInterval() * standardInterval : productPictureTimerLength;
		...
		replenishmentTimerLength = replenishmentConfig != null
				? replenishmentConfig.getM03ExeInterval() * standardInterval : replenishmentTimerLength;
		...
		vendingStatusTimerLength = vendingStatusConfig != null
				? vendingStatusConfig.getM03ExeInterval() * standardInterval : vendingStatusTimerLength;
		...
		replenishmentStatusTimerLength = replenishmentStatusConfig != null
				? replenishmentStatusConfig.getM03ExeInterval() * standardInterval : replenishmentStatusTimerLength;

		InterfaceData replenishmentDiffConfig = configMap.get(
				Constant.METHOD_WSID_REPLENISHMENT_DIFF + "_" + Constant.HTTP_OPERATE_TYPE_UPDATEDETAILDIFFERENTIAQTY);
		replenishmentDiffTimerLength = replenishmentDiffConfig != null
				? replenishmentDiffConfig.getM03ExeInterval() * standardInterval : replenishmentDiffTimerLength;
		...
		stockTransactionTimerLength = stockTransactionConfig != null
				? stockTransactionConfig.getM03ExeInterval() * standardInterval : stockTransactionTimerLength;

		InterfaceData vendingPasswordConfig = configMap
				.get(Constant.METHOD_WSID_PASSWORD + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		vendingPasswordTimerLength = vendingPasswordConfig != null
				? vendingPasswordConfig.getM03ExeInterval() * standardInterval : vendingPasswordTimerLength;
	}
	...
	private void initDownloadTask() {
		...
		// InterfaceData vendingPictureConfig =
		// configMap.get(Constant.METHOD_WSID_VENDINGPICTURE + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData vendingChnConfig =
		// configMap.get(Constant.METHOD_WSID_VENDINGCHN + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData vendingProLinkConfig =
		// configMap.get(Constant.METHOD_WSID_VENDINGPROLINK + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData productConfig =
		// configMap.get(Constant.METHOD_WSID_PRODUCT + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData productPictureConfig =
		// configMap.get(Constant.METHOD_WSID_PRODUCTPICTURE + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData supplierConfig =
		// configMap.get(Constant.METHOD_WSID_SUPPLIER + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData stationConfig =
		// configMap.get(Constant.METHOD_WSID_STATION + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData vendingCardPowerConfig =
		// configMap.get(Constant.METHOD_WSID_VENDINGCARDPOWER
		...
		// InterfaceData cardConfig = configMap.get(Constant.METHOD_WSID_CARD +
		// "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData cusEmpCardPowerConfig =
		// configMap.get(Constant.METHOD_WSID_CUSEMPCARDPOWER
		// + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData customerEmpLinkConfig =
		// configMap.get(Constant.METHOD_WSID_CUSTOMEREMPLINK
		// + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData customerConfig =
		// configMap.get(Constant.METHOD_WSID_CUSTOMER + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData productGroupConfig =
		// configMap.get(Constant.METHOD_WSID_PRODUCTGROUP + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData productGroupPowerConfig =
		// configMap.get(Constant.METHOD_WSID_PRODUCTGROUPPOWER
		// + "_" + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData replenishmentConfig =
		// configMap.get(Constant.METHOD_WSID_REPLENISHMENT + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
		...
		// InterfaceData vendingPasswordConfig =
		// configMap.get(Constant.METHOD_WSID_PASSWORD + "_"
		// + Constant.HTTP_OPERATE_TYPE_GETDATA);
	...
	public void requestConfigParse() {
		...
		configParse.requestConfigData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_CONFIG, vendingId);
	}
	...
	public void requestVendingChnParse() {
		...
		parse.setListener(this);
		parse.requestVendingChnData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_VENDINGCHN, vendingId);
	...
	public void requestVendingCardPowerParse() {
		...
		parse.setListener(this);
		parse.requestVendingCardPowerData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_VENDINGCARDPOWER,
				vendingId);
	...
	public void requestCusEmpCardPowerParse() {
		...
		parse.setListener(this);
		parse.requestCusEmpCardPowerData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_CUSEMPCARDPOWER,
				vendingId);
	...
	public void requestCustomerEmpLinkParse() {
		...
		parse.setListener(this);
		parse.requestCustomerEmpLinkData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_CUSTOMEREMPLINK,
				vendingId);
	...
	public void requestProductGroupParse() {
		...
		parse.setListener(this);
		parse.requestProductGroupData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_PRODUCTGROUP, vendingId);
	...
	public void requestProductGroupPowerParse() {
		...
		parse.setListener(this);
		parse.requestProductGroupPowerData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_PRODUCTGROUPPOWER,
				vendingId);
	...
	public void requestVendingPasswordParse() {
		...
		parse.setListener(this);
		parse.requestVendingPasswordData(Constant.HTTP_OPERATE_TYPE_GETDATA, Constant.METHOD_WSID_PASSWORD, vendingId);
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_VENDING_STSATUS:
				// 售货机在线状态更新
				VendingStatusDataParse.getInstance().requestVendingData(Constant.HTTP_OPERATE_TYPE_UPDATESTATUS,
						Constant.METHOD_WSID_VENDING_STSATUS, vendingId);
				break;
			case MESSAGE_REPLENISHMENT_STATUS:
				// 补货单状态更新
				ReplenishmentDataParse.getInstance().requestReplenishmentData(Constant.HTTP_OPERATE_TYPE_UPDATESTATUS,
						Constant.METHOD_WSID_REPLENISHMENT_STATUS, vendingId, replenishmentRowCount);
				break;
			case MESSAGE_REPLENISHMENT_DIFF:
				// 上传补货单差异
				ReplenishmentDataParse.getInstance().requestReplenishmentData(
						Constant.HTTP_OPERATE_TYPE_UPDATEDETAILDIFFERENTIAQTY, Constant.METHOD_WSID_REPLENISHMENT_DIFF,
						vendingId, replenishmentRowCount);
				break;
			case MESSAGE_INVENTORY:
				// 上传盘点记录数据
				InventoryHistoryDataParse.getInstance().requestInventoryHistoryData(Constant.HTTP_OPERATE_TYPE_INSERT,
						Constant.METHOD_WSID_INVENTORY, vendingId);
				break;
			case MESSAGE_STOCKTRANSACTION:
				// 上传库存交易记录
				StockTransactionDataParse.getInstance().requestStockTransactionData(Constant.HTTP_OPERATE_TYPE_INSERT,
