 ...
 */
JNIEXPORT jstring JNICALL Java_com_zillion_evm_jssc_SerialNativeInterface_getNativeLibraryVersion(JNIEnv *env, jobject object) {
 ...
 */
JNIEXPORT jlong JNICALL Java_com_zillion_evm_jssc_SerialNativeInterface_openPort(JNIEnv *env, jobject object, jstring portName, jboolean useTIOCEXCL){
